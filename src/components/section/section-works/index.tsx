    ...
    return (
        <>
            <section className={styles.container__sectionWorks}>
                <div>
                    <h1>
                        Lumos construindo o caminho para o sucesso digital da
                        sua marca.
                    </h1>
                    <p>
                        Da criação de páginas simples até sistemas mais
                        complexos, fornecemos serviços e trazemos seu negócio
                        para o digital de forma personalizada!
                    </p>
