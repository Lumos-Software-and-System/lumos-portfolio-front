      ...
      <ul>
        <li className={styles["list--notbook"]}>
          ...
          <div>
            ...
            <p>
              Diversos modelos de sites personalizados que garantem uma presença
              online profissional e eficaz para o seu negócio.
            </p>
            <button>
        ...
        <li className={styles["list--table"]}>
          ...
          <div>
            ...
            <p>
              Trazemos sua loja física para o virtual para impulsionar suas
              vendas e facilitar o dia a dia do seu negócio.
            </p>
            <button>
        ...
        <li className={styles["list--mobile"]}>
          ...
          <div>
            ...
            <p>
              Criamos o software que você necessita de forma personalizada para
